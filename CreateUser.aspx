...
<body>
  ...
  <div class="row" align="center">
    ...
    <form id="form1" runat="server">
        ...
        <asp:CreateUserWizard ID="CreateUserWizard1" runat="server" ActiveStepIndex="0" OnCreatedUser="CreateUserWizard1_CreatedUser1">
            <WizardSteps>
    ...
    <asp:Label ID="suck" runat="server"></asp:Label>
</body>
</html>
